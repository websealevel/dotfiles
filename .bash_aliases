...
alias cours="cd /home/paul/depots/paul-schuhm/enseignement/cours/";
...
function md2htmltoc(){
	...
	pandoc $1 -f markdown+tex_math_double_backslash -t html5 -s -o ${filename}.html --toc --toc-depth=2 --strip-comments --mathml --css style.css
	echo "Saved to $filename.html";
}

function md2htmltoch2id(){
	filename="${1%%.*}"
	#si pas de fichier style.css local en creer un
	if [ -e "style.css" ]; then
		echo "Stylesheet found"
...
alias marp2pdf-theme="marp --html --theme theme.css --pdf --allow-local-files"
...
alias marpw-theme="marp --html --theme theme.css -w --allow-local-files"
...
alias edfac="php -S localhost:5566 -t /home/paul/depots/paul-schuhm/editeur-factures/src/public --php-ini=/home/paul/depots/paul-schuhm/editeur-factures/php-prod.ini"
alias tv="xawtv"

#Writer workbench - Correction
alias check="aspell check"
alias ls-services="systemctl list-units --type=service"
alias scanports="nmap -sT -O localhost"
